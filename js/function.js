...
function converter_area(){
	...
	if (to == 'ha') {
		...
		document.getElementById('area-from-unit-label').innerText = from;
		document.getElementById('area-to-unit-label').innerText = to;
		document.getElementById('area-from-unit-des').innerHTML = des.sqha;
		document.getElementById('area-to-unit-des').innerHTML = x;}
	if (from == 'acre') {
	if (to == 'acre') {
		...
		document.getElementById('area-from-unit-label').innerText = from;
		document.getElementById('area-to-unit-label').innerText = to;
		document.getElementById('area-from-unit-des').innerHTML = des.sqacre;
		document.getElementById('area-to-unit-des').innerHTML = x;}
	if (from == 'cm') {
	if (to == 'cm') {
...
function converter_tpt() {
	...
	if (to == 'C') {
		...
		document.getElementById('tpt-from-unit-des').innerHTML = des.Cencius;
